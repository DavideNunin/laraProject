...
<div class ="row">
        ...
        <div class="col-lg-6 ">
            <label for="coajf" class="form-label">Che tipo di utente sei?</label>
        ...
        <div class="col-lg-6 register-button text-center">
            <button type="button" class="btn login-button btn-primary btn-block mb-4" >Registrati</button>
        </div>
    </div>
</form>
